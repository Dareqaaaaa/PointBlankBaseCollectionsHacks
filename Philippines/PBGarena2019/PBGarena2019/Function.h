...
public:
	...
	{
		return ((D3DXMATRIX*(__thiscall*)(i3RenderContext*))(GetProcAddress(Utils->i3GfxDx, /*?GetProjectMatrix@i3RenderContext@@QAEPATMATRIX@@XZ*/XorStr<0x27, 52, 0xF8A010B3>("\x18\x6F\x4C\x5E\x7B\x5E\x42\x44\x4A\x53\x45\x7F\x52\x40\x47\x5F\x4F\x78\x50\x09\x69\x59\x53\x5A\x5A\x32\x02\x2D\x2D\x30\x20\x3E\x33\x08\x09\x1B\x0A\x09\x1D\x0F\x1B\x1D\x10\x06\x01\x1D\x0D\x16\x17\x00\x03" + 0xF8A010B3).s)))(this);
	}
	D3DXMATRIX* GetWorldMatrix() {
		return ((D3DXMATRIX*(__thiscall*)(i3RenderContext*))(GetProcAddress(Utils->i3GfxDx, /*?GetWorldMatrix@i3RenderContext@@QAEPATMATRIX@@XZ*/XorStr<0xD8, 50, 0x5EABD911>("\xE7\x9E\xBF\xAF\x8B\xB2\xAC\xB3\x84\xAC\x83\x97\x96\x8C\x9E\xA7\x81\xDA\xB8\x8E\x82\x89\x8B\x9D\xB3\x9E\x9C\x87\x91\x8D\x82\xB7\xB8\xA8\xBB\xBE\xAC\xBC\xAA\xB2\x41\x55\x50\x4A\x5C\x45\x46\x5F\x52" + 0x5EABD911).s)))(this);
	}
	D3DXMATRIX* GetViewMatrix() {
		return ((D3DXMATRIX*(__thiscall*)(i3RenderContext*))(GetProcAddress(Utils->i3GfxDx, /*?GetViewMatrix@i3RenderContext@@QAEPATMATRIX@@XZ*/XorStr<0xA3, 49, 0xF6D3D3AA>("\x9C\xE3\xC0\xD2\xF1\xC1\xCC\xDD\xE6\xCD\xD9\xDC\xC6\xC8\xF1\xDB\x80\xE6\xD0\xD8\xD3\xDD\xCB\xF9\xD4\xD2\xC9\xDB\xC7\xB4\x81\x82\x92\x85\x80\x96\x86\x9C\x84\x8B\x9F\x9E\x84\x96\x8F\x90\x89\x88" + 0xF6D3D3AA).s)))(this);
	}
};
...
public:
	i3SceneObject * getSceneObject(void) {
		static const oGetSceneObject pGetSceneObject = (oGetSceneObject)GetProcAddress(Utils->i3FrameworkDx, /*?getSceneObject@i3GameObj@@QBEPAVi3SceneObject@@XZ*/XorStr<0x20, 51, 0x21681C6B>("\x1F\x46\x47\x57\x77\x46\x43\x49\x4D\x66\x48\x41\x49\x4E\x5A\x6F\x59\x02\x75\x52\x59\x50\x79\x55\x52\x79\x7A\x6A\x7E\x78\x6E\x7E\x16\x28\x71\x10\x27\x20\x28\x22\x07\x2B\x20\x2E\x2F\x39\x0E\x0F\x08\x0B" + 0x21681C6B).s);
		return (i3SceneObject *)pGetSceneObject(this);
	}
	D3DXVECTOR3 * getPos(void) {
		static const oGetPos pGetPos = (oGetPos)GetProcAddress(Utils->i3FrameworkDx, /*?GetPos@i3GameObj@@QAEPATVEC3D@@XZ*/XorStr<0x95, 35, 0xA85CE5B3>("\xAA\xD1\xF2\xEC\xC9\xF5\xE8\xDC\xF4\xAD\xD8\xC1\xCC\xC7\xEC\xC6\xCF\xE6\xE7\xF9\xE8\xEF\xFB\xED\xF9\xF8\xEA\xF3\x82\xF6\xF3\xF4\xED\xEC" + 0xA85CE5B3).s);
...
private:
	...
	{
		return (i3RenderContext *)(*(DWORD*)(GetProcAddress(Utils->i3GfxDx, /*?g_pRenderContext@@3PAVi3RenderContext@@A*/XorStr<0xB8, 42, 0xC8ED595D>("\x87\xDE\xE5\xCB\xEE\xD8\xD0\xDB\xA5\xB3\x81\xAC\xAA\xB1\xA3\xBF\xBC\x89\x8A\xF8\x9C\x8C\x98\xA6\xE3\x83\xB7\xBD\xB0\xB0\xA4\x94\xB7\xB7\xAE\xBE\xA4\xA9\x9E\x9F\xA1" + 0xC8ED595D).s)));
	}

	//Bone ESP Draw
	void DrawBoneLine(int index, const char * Start, const char * End, DWORD Color, LPDIRECT3DDEVICE9 pDevice);
	void EspDrawBone(int index, DWORD Color, LPDIRECT3DDEVICE9 pDevice);
...
public:
	...
	float fPZ;
	int SavePosition;
	void SetPosHelper(DWORD ptr, bool &test);
	//
	DWORD dwSetEndCheck;
	float fX;
	float fY;
